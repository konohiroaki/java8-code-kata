...
public class Exercise3Test {
    ...
    public void localDateTimeOf() {
         ...
         */
        LocalDate ld = LocalDate.of(2015, 6, 20);
        LocalTime lt = LocalTime.of(23, 7, 30);
    ...
    public void localDatePlusMinus() {
        ...
        LocalDateTime localDateTime = ldt.plus(10,ChronoUnit.MONTHS).minus(5, ChronoUnit.HOURS);
