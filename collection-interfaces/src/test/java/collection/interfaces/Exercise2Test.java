...
public class Exercise2Test {
  ...
  public void getDefaultValue() {
    ...
    /**
     * Try to get from key "Alice" using {@link Map#getOrDefault}. If the key doesn't exist, use 30
     * as default.
     */
  ...
  public void putIfNotExisting() {
    ...
    /**
     * Try to put 2 entry with key as "Alice" value as 32, key as "Joe" and value as 32 using
     * {@link Map#putIfAbsent}.
     */
  ...
  public void mergeValues() {
    ...
    /**
     * Merge 2 entry to {@link map} with key="Alice" value=32, key="Joe" value=32 using
     * {@link Map#merge}. If the value already exist for the key, remap with sum value.
     */
  ...
  public void ignoringAbsentKeys() {
    ...
    /**
     * Try to increment the value for keys "Joe", "Steven" and "Alice" using
