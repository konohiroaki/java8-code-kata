...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(customer -> customer.getAge()).sorted();
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((a,b) -> b.getBudget()-a.getBudget()).map(customer -> customer.getName()).limit(3);
