...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(Customer::getAge).sorted(Integer::compare);
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (o1, o2) -> Integer.compare(o2, o1);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((o1, o2) -> Integer.compare(o2.getBudget(), o1.getBudget())).map(Customer::getName).limit(3);
