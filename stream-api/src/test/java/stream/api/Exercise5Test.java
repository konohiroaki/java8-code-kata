...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void nameList() {
         ...
         */
        List<String> nameList = customerList.stream().map(customer -> customer.getName()).collect(Collectors.toList());
    ...
    public void oldestCustomer() {
         ...
         */
        Optional<Customer> oldestCustomer = customerList.stream().collect(Collectors.maxBy((a,b)-> a.getAge()-b.getAge()));
